...
int main(int argc, char** argv) {
    ...
    std::cout << "Generating 3D+T robust moving spheres intersection data..." << std::endl;
    ...
    for (int t = 0; t < DT; ++t) {
        // Sphere 1: Static at center, R=10
        double c1x = 16.0, c1y = 16.0, c1z = 16.0, r1 = 10.0;
        // Sphere 2: Moving along Y, R=8
        // Offset starts at 6.0, moves to 6.0 + 9*0.5 = 10.5
        // Distance between centers: d = sqrt(6^2 + (0.5t)^2). 
        // This ensures they always intersect (2 < d < 18)
    ...
    std::cout << "Writing results to fiber_3d.vtu..." << std::endl;
    write_complex_to_vtu(complex, *mesh, "fiber_3d.vtu", 2);
